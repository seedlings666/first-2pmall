        ...
        <div class="col-xs-12 form-horizontal">
            ...
            <form role="form" id="validation-form" method="get" action="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="clearfix">
                            <input type="text" id="goods_name" name="goods_name" placeholder="店铺名称" class="col-xs-5" />
                        </div>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label no-padding-right" for="goods_desc"> 负责人 </label>

                    <div class="col-sm-10">
                        <div class="clearfix">
                            <input type="text" id="goods_desc" name="goods_desc" placeholder="负责人" class="col-xs-12" />
                        </div>
                    </div>
                </div>
